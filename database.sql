...
create index if not exists idx_verifications_id on verifications(id);
create index if not exists idx_verifications_inquiry_id on verifications(inquiry_id);
...
create index if not exists idx_verifications_persona_account_id on verifications(persona_account_id);
